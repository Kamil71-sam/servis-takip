        ...
        <head>
          ...
          <style>
            * { box-sizing: border-box; }
            ...
            /* 🚨 YENİ IBAN ŞERİDİ (ALTTA VE GENİŞ) */
            .bank-footer {
            ...
            .bank-strip {
              ...
              font-size: 11px; /* Rakamları küçülttük */
              color: #333;
            }
            .bank-row {
              display: flex;
            ...
            <tr>
              ...
              <td>
                ...
                <div class="box-content">
                  ...
                  <strong>GSM:</strong> ${musteri.telefon || '-'}<br>
                  ${musteri.vergiNo ? `<strong>Vergi No:</strong> ${musteri.vergiNo}` : ''}
                </div>
              </td>
              <td class="spacer"></td>
              <td>
                ...
                <div class="box-content">
                  ...
                  <strong>Seri / Barkod:</strong> ${cihaz.seriNo}
                </div>
              </td>
            </tr>
          </table>
          ...
          <table class="item-table">
            <thead>
              <tr>
                ...
                <th width="10%" class="center">MİKTAR</th>
                <th width="15%" class="center">BİRİM FİYAT</th>
                <th width="10%" class="center">KDV</th>
                <th width="20%" class="right">TOPLAM</th>
              </tr>
            </thead>
